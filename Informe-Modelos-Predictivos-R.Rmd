...
```{r, Modelo J48 con 8 predictores, warning=T}
set.seed(1)
...
```{r, Modelo J48 con 4 predictores, warning=T}
set.seed(1)
...
Al igual que el primer modelo de `J48` y el de `MLP`, esta regresión también se realizará con 8 predictores más la clase. Nótese que RegLog requiere de 300 semillas de aleatoriedad durante su entrenamiento.
...
|-------------------|---------------|---------------|---------------|
|J48 (8 predictores)|   0.4565051   |   0.2687958   |   0.7068018   |
|J48 (4 predictores)|   0.4551964   |   0.2632029   |   0.7161267   | 
|       MLP         |   0.4625404   |   0.2621256   |   0.7419192   |
|    __RegLog__     | __0.5068602__ | __0.3217057__ | __0.7693466__ | 
...
# Resumen visual de las métricas de interés
boxplot(datos_muestreo$values[,-1], col = "aquamarine", las= 2, cex.axis = 0.8)
