...
```{r, Modelo J48 con 8 predictores, warning=T, cache=T}
set.seed(1)
...
```{r, Modelo J48 con 4 predictores, warning=T, cache=T}
set.seed(1)
...
A continuación hacemos el __contraste para la igualdad de varianzas__ de los índices Kappa. Como son 4 poblaciones __normales y dependientes, usaremos el __test de esfericidad de Mauchly__, cuya hipótesis nula H0 establece que se cumple la condición de homocedasticidad en las muestras.
...
A continuación hacemos el __contraste para la igualdad de varianzas__ del AUC. Como son 4 poblaciones __normales y dependientes, usaremos el __test de esfericidad de Mauchly__, cuya hipótesis nula H0 establece que se cumple la condición de homocedasticidad en las muestras.
