...
# Detectamos células ancla en nuestros datasets mediante un CCA
transfer.anchors <- FindTransferAnchors(reference = allen_rna, query = MB_Signac, 
                                        reduction = "cca", dims = 1:40) # Nota: ya que usamos datasets pesados, no divergentes (mirar UMAP) y de la misma especie, es computacionalmente más eficiente usar `reduction = "rpca"`

# Integramos los datasets de scATAC-seq y scRNA-seq
...
# Añadimos la clasificación de los clusters a nuestro objeto `seurat` principal
