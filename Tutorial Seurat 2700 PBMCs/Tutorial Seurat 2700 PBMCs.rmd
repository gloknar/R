...
```{r}
# Puedes usar el parámetro 'label = TRUE` del comando `DimPlot` para visualizar
# mejor los clusters
DimPlot(pbmc, reduction = "umap", label = T) # label = "FALSE" by default
```
...
El argumento `min.pct` requiere , y el parámetro `threst.test` requiere una característica ser diferencialmente expresada (en promedio) por una cantidad entre los dos grupos. Puedes poner ambos argumentos a 0, pero el algoritmo irá mucho más lento ()
