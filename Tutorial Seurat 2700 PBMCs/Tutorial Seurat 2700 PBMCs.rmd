...
Después aplicamos una transformación linear (escalado) que es un paso común de preprocesado previo a la aplicación de técnicas de reducción de dimensionalidad (también llamado extracción de características en ML) como PCA. 
