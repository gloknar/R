...
# Nota: la estrategia "multiprocess" está obsoleta. En su lugar se usa el
# parámetro "multicore".
plan()
```
...
```{r, cache = T}
# Evaluamos la velocidad obtenida por paralelizar el comando `JackStraw` con el paquete `future`.
