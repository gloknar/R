...
Los clusters con sus respectivas células se guardan en `pbmc@active.ident`. Alternativamente, podemos acceder a dicha información con el comando `Idents(pbmc)`. 
