...
```{r}
# Nota: usar https://satijalab.org/seurat/v3.2/future_vignette.html para
# paralelizar NormalizeData, ScaleData, JackStraw, FindMarkers y quizás
# FindClusters (solo si hacemos clustering   over multiple resolutions; nosotros usamos `resolution = 0.5`)
library(future)
plan(strategy = "multicore", workers = 4)
# Nota: la estrategia "multiprocess" de la guía original está obsoleta. En su lugar se usa el
# parámetro "multicore".
plan()
```
