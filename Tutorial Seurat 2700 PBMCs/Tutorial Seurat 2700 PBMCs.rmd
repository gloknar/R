...
```{r}
# Nota: usar https://satijalab.org/seurat/v3.2/future_vignette.html para paralelizar JackStraw y más cosas de Seurat?
library(future)
plan(strategy = "multicore", workers = 4)
# Nota: la estrategia "multiprocess" está obsoleta. En su lugar se usa el parámetro"multicore".
plan()
```

```{r, cache=T}
# Nota: El JackStraw puede tardar en completarse
# pbmc <- JackStraw(pbmc, dims = 1:5)
pbmc <- JackStraw(pbmc, dims = 5)
# pbmc <- ScoreJackStraw(pbmc, dims = 1:15)
pbmc <- ScoreJackStraw(pbmc, dims = 1:5)
# f <- future(JackStraw(pbmc))
# ?future
```
