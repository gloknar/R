...
asignaciones <-  asignaciones %>% arrange(ClusterID) # Arreglar eso de bladder_1, bladder_10, bladder_11, bladder_2...
...
```{r}
# Hacemos un vector con el nombre de los clusters ordenados 
