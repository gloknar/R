...
eliminar <- which(metricas_nzv[,"zeroVar"] == T)  # NO hay ninguno, entonces no hacemso este paso (revienta el dataset si haces dataset[-0,])
...
# Mirar AUC con pROC (mirarlo en imputado por BY de semen)
# library(pROC)
# library(caret)
