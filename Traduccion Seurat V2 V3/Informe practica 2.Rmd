...
```{r}
# Biomarcadores
ouija_markers_down <- c("Hoxa1", "Rhoa", "Sox2")
ouija_markers_transient <- c("Zscan4b", "Foxa1")
ouija_markers_up <- c("Creb3", "Carm1", "Creb1")
ouija_markers <- c(ouija_markers_up, ouija_markers_down, ouija_markers_transient)
...
options(mc.cores = parallel::detectCores())
oui_2 <- ouija(x = deng_SCE[ouija_markers,],
                response_type = response_type,
                switch_strengths = switch_strengths,
                switch_strength_sd = switch_strength_sd,
                inference_type = "vb", # "vb" = ADVI
...
plot_expression(oui_2) + scale_x_reverse()

plot_switch_times(oui_2)
```
