...
__Solución:__
La tabla anterior nos confirma mediante el susodicho test a pares la información previamente obtenida en el gráfico de expresión génica a lo largo del pseudotiempo (comando `plot_expression`).
...
Si comparamos dos genes monotónicos de la etapa temprana, Dazl y Egfr, el segundo se activa antes que el primero. 
