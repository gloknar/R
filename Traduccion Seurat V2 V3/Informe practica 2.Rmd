...
```{r}
# Violín
plotExpression(deng_SCE, features = c("Rhoa, hoxa1"), x = "cell_type2", colour_by = "cell_type2") + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1))
...
* Regula procesos de desarrollo como formación del brainstem, oído interior y exterior, nervio abducens y el sistema cardiovascular

* El producto génico podría estar involucrado en la generación de sementos del hindbrain del eje anterior-posterior (delante-arriba
