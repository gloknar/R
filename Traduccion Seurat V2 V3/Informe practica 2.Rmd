...
Compara los gráficos de violín y los del comando `plotExpression()` de `ouija`, pues son muy parecidos...

```{r}
# ouija

ouija_markers_down <- c("Hoxa1", "Creb3")
ouija_markers_transient <- c("Zscan4b", "Foxa1") 
ouija_markers_up <- c("Rhoa") # Mirar gen Sox2
