...
ggplot(as.data.frame(colData(deng_SCE)), 
       ...
       theme_classic() + theme(plot.title = element_text(size = 10, hjust = 0.40)) +
...
`ouija` identifica en este caso 5 estados celulares metaestables, los cuales anotaremos como “zygote/2cell”, “4cell”, "8/16 cell/early blast", “mid blast” and “late blast”.
...
<details>
<summary> __Ejercicio 2.3: ¿Cómo cambian los resultados al elegir otros biomarcadores o cambiar las _a priori_?__</summary>
