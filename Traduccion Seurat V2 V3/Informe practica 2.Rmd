...
¿Cómo se comparan las trayectorias inferidas por el PCA, `TSCAN`, `destiny`, `SLICER` y `ouija`?

Ajustaremos el pseudotiempo de los diversos métodos para que todos estén en el mismo sentido, y poder así realizar las comparaciones pertinentes
...
Aquí vemos que `ouija`, `TSCAN` y `SLICER` dan trayectorias fuertemente correlacionadas con la 1ª CP. La trayectoria computada por `destiny` está menos correlacionada con el resto de métodos.

<br>

<details> 
<summary> __Ejercicio 2.4: Compara los métodos en mayor profundidad. ¿Dónde y cómo difieren?__</summary>
