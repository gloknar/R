...
* brainstem, inner and outer ear, abducens nerve and cardiovascular development
* 

* The encoded protein may be involved in the placement of
hindbrain segments in the proper location along the anterior-posterior axis
during development. Two transcript variants encoding two different isoforms have
been found for this gene, with only one of the isoforms containing the
homeodomain region. [provided by RefSeq, Jul 2008]
