...
Luego se proyectan las células al espacio del PCA (por defecto se calculan las 50 1<sup>as</sup> componentes) para eliminar ruido y facilitar la computación de los siguientes pasos.

Then, you as the user choose whether to reduce the dimensionality
...
# Instalación de Monocle 2.14 en BioConductor 3.10
...
# Importamos el dataset de Seurat a Monocle  
data <- readRDS(file = 'Archivos accesorios/Codigo y datos de las Practicas 1-4/data/nakamura_P4.rds')
head(data@meta.data)
...
```{r, fig.width=6, fig.height=6.5, eval =F}
############################
# Step 1: Normalize and pre-process the data
############################
