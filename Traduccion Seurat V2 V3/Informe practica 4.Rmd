...
# Ordenamos los genes en función de su q-valor
moran_test_principal_graph <- arrange(moran_test_principal_graph, q_value)

# Visualizamos los genes más significativos
head(moran_test_principal_graph)
...
La anotación génica aportada por gProfiler para el módulo 1 implica transporte celular de moléculas.
