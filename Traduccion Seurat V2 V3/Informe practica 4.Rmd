...
# Creamos un nuevo objeto CellDataSet a partir del objeto seurat:
#c3 <- monocle::importCDS(data, import_all = FALSE) borrar?
...
c3 <- order_cells(c3, reduction_method = "UMAP", verbose = T)
