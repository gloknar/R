...
> nota: PDX1 es un gen arquitecto para la producción del páncreas, pero me interesa buscar el gen de la insulina (INS), que es carcaterístico de las células $\beta$ . Sinónimos de INS son IDDM2, ILPR, INS_HUMAN, IRDN y MODY10
...
FeaturePlot(pancreas.integrated, reduction ='umap', features = c("PDX1","INS2"), 
            min.cutoff = "q9", cols = c("lightgrey", "blue"), pt.size = 0.5)

FeaturePlot(pancreas.integrated, reduction ='umap', features = c("PDX1","MAFA"), 
            min.cutoff = "q9", cols = c("lightgrey", "blue"), pt.size = 0.5)
...
Ahora podemos comparar con las células $\beta$ del paper
