...
```{r}
cluster.beta.markers <- FindMarkers(pancreas.integrated, ident.1 = c(1,2), min.pct = 0.25, only.pos = T)
head(cluster.beta.markers)
cluster.beta.markers
which(rownames(cluster.beta.markers) == "PDX1")
```
